...
- **Greedy (貪心)** - sort、swap 局部最好的選擇
- **Backtracking (回溯)** - N 皇后、子集排列組合、數獨
- **Divide and Conquer (分治)** - Merge Sort、Quick Sort
- **Binary Search (二分搜尋)** - low/high
- **Two Pointers (雙指針)** - left/right
- **Sliding Window (滑動視窗)** - 固定或可變窗口
...
- **bitset (位集合)** - set/reset/flip/count/any/to_string，快速集合運算

### 字串算法 (String Algorithms)
